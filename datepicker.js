...
//     let calendarContainer = calendar.children[0].setAttribute('class', 'hide');
//     // CalendarComponent.calendar(calendar);
//     // calendarContainer = calendar.children[0].deleteClass('hide');
//     // $('#datepicker').elems[0].addEventListener('click', function () {
